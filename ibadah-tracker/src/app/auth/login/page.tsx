...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6"
      ...
      <div className="glass rounded-3xl p-10 w-full max-w-md text-center animate-fadeIn glow-accent">
        <div className="text-5xl mb-4">🕌</div>
        <h1 className="text-3xl font-bold mb-2 gradient-text">Welcome Back</h1>
        <p className="mb-8 text-sm" style={{ color: '#94a3b8' }}>
          Sign in to continue your ibadah journey
        </p>
        <button
          onClick={handleGoogleLogin}
          className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl font-semibold transition-all hover:scale-105"
          style={{
